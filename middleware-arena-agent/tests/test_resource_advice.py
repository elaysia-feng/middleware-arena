...
from app.schemas.resource import ResourceAdviceRequest
...
class ResourceAdviceTest(unittest.TestCase):
    ...
    @patch(
        "app.services.resource_advice.request_resource_advice",
    ...
    @patch("app.services.resource_advice.request_resource_advice")
