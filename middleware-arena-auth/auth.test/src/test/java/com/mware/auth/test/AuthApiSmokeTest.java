...
/** Auth 服务真实 HTTP 接口冒烟测试。 */
class AuthApiSmokeTest {

    private static final String ENABLE_PROPERTY = "ma.it.enabled";
    private static final String BASE_URL_PROPERTY = "ma.it.auth.base-url";
    private static final String DEFAULT_BASE_URL = "http://127.0.0.1:9001";
